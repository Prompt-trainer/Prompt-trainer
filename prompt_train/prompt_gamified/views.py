...
from users.models import CustomUser, Cosmetic, UserCosmetic
...
def store_view(request):
    ...
    cosmetics = Cosmetic.objects.exclude(type="rank_ring")

    # Отримуємо список id елементів косметики, купленної користувачем
    purchased_ids = set(
